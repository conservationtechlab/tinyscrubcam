...
const char* ei_classifier_inferencing_categories[] = { "bald eagle", "pigeon" };

ei_dsp_named_axis_t ei_dsp_config_10_named_axes[] = {
    { .name = "Signal", .axis = 0 }
};
size_t ei_dsp_config_10_named_axes_size = 1;
uint8_t ei_dsp_config_10_axes[] = { 0 };
const uint32_t ei_dsp_config_10_axes_size = 1;
ei_dsp_config_spectrogram_t ei_dsp_config_10 = {
    10, // uint32_t blockId
    4, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_10_named_axes, // named axes
    ei_dsp_config_10_named_axes_size, // size of the named axes array
...
const uint32_t ei_learning_block_5_inputs[1] = { 10 };
...
const ei_impulse_t impulse_434765_0 = {
    .project_id = 434765,
    .project_owner = "Venz Burgos",
    .project_name = "BirdDetect",
    .deploy_version = 1,
...
ei_impulse_handle_t impulse_handle_434765_0 = ei_impulse_handle_t( &impulse_434765_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_434765_0;
